...
public class StrafeLeftToNotColorOperation extends StrafeLeftToColorOperation {
     ...
     * @param title
     */
    public StrafeLeftToNotColorOperation(Type type, double speed, String title) {
        super(type, speed, title);
    }

    public String toString() {
        return String.format(Locale.getDefault(), "StrafeLeftToNotColor: %s@%.2f --%s",
